...
namespace ZeroMQ
{
    public class USub
    {
        protected readonly object clrZmqSubscriberSyncObj = new object();
        protected ZSocket clrZmqSubscriber;
        protected long clrZmqReceivedCounter = 0;

        public readonly ReadOnlyCollection<string> DataPubUrls;
        public readonly byte[] subscriptionTopic;
        ...
        public USub(ReadOnlyCollection<string> dataPubUrls, byte[] topic)
        {
